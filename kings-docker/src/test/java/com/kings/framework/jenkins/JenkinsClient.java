package com.kings.framework.jenkins;
...
public class JenkinsClient {
    ...
    static final String JENKINS_PASSWORD = "2360d52c11784897be081f12a13e66dd";
    static final String JOB_NAME = "kings-application";
    ...
    static class JobApi {
        ...
        JobApi() {
            // 连接 Jenkins
            jenkinsServer = JenkinsClient.connection();
            // 设置客户端连接 Jenkins
            jenkinsHttpClient = JenkinsClient.getClient();
        }
