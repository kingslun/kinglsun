...
import com.zatech.octopus.component.distributed.zookeeper.config.OctopusZookeeperProperties;
...
/**
 * <p>write your description for this enum...
 * 屏蔽curator框架策略</p>
 *
 * @author lun.wang
 ...
 * @title zookeeper client连接server的重试策略
 * @since v2.7.5
 */
public enum RetryType {
    ...
    RETRY_UNTIL_ELAPSED {
        @Override
        public RetryPolicy policy(OctopusZookeeperProperties.Retry retry) {
            Assert.notNull(retry, "retry is null");
    ...
    public abstract RetryPolicy policy(OctopusZookeeperProperties.Retry retry);
}
