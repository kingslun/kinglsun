...
class ZookeeperAsyncProvider extends AbstractZookeeper<Serializable>
    ...
    protected ZookeeperAsyncProvider(CuratorFramework curatorFramework,
                                     ExecutorService threadPool, ZookeeperSerializer serializer) {
     ...
     */
    private ZookeeperAsyncResponse convert(CuratorEvent curatorEvent) throws OctopusZookeeperSerializeException {
    ...
    public ZookeeperWriter<String, Serializable> create(String s, Serializable s2, NodeMode mode,
        ...
        try {
            ...
            if (this.nonexistent(path0(s))) {
                ...
                builder.inBackground(this, this.threadPool())
    ...
    public ZookeeperWriter<String, Serializable> deleteWithVersion(String s, int version)
        ...
        try {
            ...
            curatorFramework.delete().withVersion(version)
    ...
    public ZookeeperWriter<String, Serializable> update(String s, Serializable s2)
        ...
        try {
            ...
            curatorFramework.setData()
                    .inBackground(this, this.threadPool())
                    .withUnhandledErrorListener(this)
                    .forPath(path0(s), this.serializer.serialize(s2));
            return this;
        } catch (Exception e) {
            throw new OctopusZookeeperException(e);
        }
    ...
    public ZookeeperWriter<String, Serializable> update(String s, Serializable s2, int version)
        ...
        try {
            ...
            curatorFramework.setData().withVersion(version)
                    .inBackground(this, this.threadPool())
                    .withUnhandledErrorListener(this)
                    .forPath(path0(s), this.serializer.serialize(s2));
            return this;
    ...
    public Serializable get(String s) throws OctopusZookeeperException {
        try {
            ...
            byte[] data = curatorFramework.getData()
                    ...
                    .withUnhandledErrorListener(this)
                    .forPath(path0(s));
            return this.deserialize(this.serializer, data);
