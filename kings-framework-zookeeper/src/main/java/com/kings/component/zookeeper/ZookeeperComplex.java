...
import com.kings.component.zookeeper.exception.OctopusZookeeperAsyncException;
...
import com.kings.component.zookeeper.exception.OctopusZookeeperWatcherException;
...
/**
 * zookeeper操作对象
 * zookeeper服务节点操作客户端实现
 * 说明：
 * <p>
 * 实现节点的增删改查、节点监听、及事物和异步操作集的封装
 * 满足多线程操作,线程安全问题依赖curator
 * 并对curator完全封装 屏蔽所有的api和zk相关功能
 ...
 * @since v2.7.5
 */
interface ZookeeperComplex<K, V> extends Zookeeper {
     ...
     */
    Collection<ZookeeperTransactionResponse> inTransaction(Consumer<ZookeeperTransaction<K, V>> action)
     ...
     */
    OctopusZookeeper inAsync(Consumer<ZookeeperAsync<K, V>> action, ZookeeperAsyncCallback<K, V> callback,
                             ZookeeperAsyncErrorListener listener) throws OctopusZookeeperAsyncException;
     ...
     */
    default OctopusZookeeper registerPathWatcher(K path, ZookeeperPathWatcher<K, V> pathListener)
     ...
     * @return this
     * @throws OctopusZookeeperWatcherException failed
     */
    OctopusZookeeper registerPathWatcher(K path, ZookeeperPathWatcher<K, V> pathListener,
     ...
     * *  更新子节点：type=CHILD_UPDATED, data=ChildData{path='/zktest111/tt1', stat=4294979983,
     * *  4294979993,1501037475236,1501037733805,2,0,0,0,6,0,4294979983
     ...
     */
    default OctopusZookeeper registerPathChildrenWatcher(K path,
     ...
     * @throws OctopusZookeeperWatcherException failed
     */
    OctopusZookeeper registerPathChildrenWatcher(K path, ZookeeperPathChildrenWatcher<K, V> listener,
                                                 ZookeeperSerializer serializer)
            throws OctopusZookeeperWatcherException;
     ...
     * @return this
     * @throws OctopusZookeeperWatcherException register watcher fail
     * @see this#registerPathAndChildrenWatcher(Object, boolean, boolean, int, ExecutorService, ZookeeperPathAndChildrenWatcher)
     */
    default OctopusZookeeper registerPathAndChildrenWatcher(K path, boolean cacheData,
        ...
        try {
            ...
            throw new OctopusZookeeperWatcherException(e);
        }
    }
     ...
     * @see this#registerPathAndChildrenWatcher(Object, boolean, boolean, int, ExecutorService, ZookeeperPathAndChildrenWatcher)
     */
    default OctopusZookeeper registerPathAndChildrenWatcher(K path, ZookeeperPathAndChildrenWatcher<K, V> watcher,
                                                            ZookeeperSerializer serializer)
            throws OctopusZookeeperWatcherException {
        try {
     ...
     * @see this#registerPathAndChildrenWatcher(Object, boolean, boolean, int, ExecutorService, ZookeeperPathAndChildrenWatcher)
     */
    default OctopusZookeeper registerPathAndChildrenWatcher(K path, int maxDepthWatcher,
                                                            ZookeeperPathAndChildrenWatcher<K, V> watcher)
            throws OctopusZookeeperWatcherException {
        try {
     ...
     * @see this#registerPathAndChildrenWatcher(Object, boolean, boolean, int, ExecutorService, ZookeeperPathAndChildrenWatcher)
     */
    default OctopusZookeeper registerPathAndChildrenWatcher(K path,
                                                            ZookeeperPathAndChildrenWatcher<K, V> watcher)
            throws OctopusZookeeperWatcherException {
        try {
    ...
    default OctopusZookeeper registerPathAndChildrenWatcher(K path, boolean cacheData,
            ...
            throws OctopusZookeeperWatcherException {
        return this.registerPathAndChildrenWatcher(path, cacheData, createParentPath, maxDepthWatcher, threadPool,
                listener, null);
    }
     ...
     * @since v2.8.6
     */
    OctopusZookeeper registerPathAndChildrenWatcher(K path, boolean cacheData,
                                                    boolean createParentPath,
                                                    int maxDepthWatcher,
                                                    ExecutorService threadPool,
                                                    ZookeeperPathAndChildrenWatcher<K, V> listener,
