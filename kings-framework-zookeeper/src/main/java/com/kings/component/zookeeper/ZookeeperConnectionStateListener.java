...
public interface ZookeeperConnectionStateListener {
     ...
     * @param consumer 消费者
     */
    default void connected(OctopusZookeeper consumer) {
     ...
     * @param consumer 消费者
     */
    default void suspended(OctopusZookeeper consumer) {
     ...
     * @param consumer 消费者
     */
    default void reconnected(OctopusZookeeper consumer) {
     ...
     * @param consumer 消费者
     */
    default void lost(OctopusZookeeper consumer) {
     ...
     * @param consumer 消费者
     */
    default void readOnly(OctopusZookeeper consumer) {
