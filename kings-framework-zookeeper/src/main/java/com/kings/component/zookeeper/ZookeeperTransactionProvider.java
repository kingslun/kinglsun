...
class ZookeeperTransactionProvider extends AbstractZookeeper<Serializable>
    ...
    ZookeeperTransactionProvider(CuratorFramework client, ExecutorService threadPool, ZookeeperSerializer serializer) {
     ...
     */
    @Override
    public Collection<ZookeeperTransactionResponse> commit() throws OctopusZookeeperTransactionException {
        try {
