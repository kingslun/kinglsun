...
public interface ZookeeperWriter<K, V> {
     ...
     * @throws OctopusZookeeperException failed
     */
    default ZookeeperWriter<K, V> create(K k, V v, ZookeeperSerializer serializer) throws OctopusZookeeperException {
     ...
     * @see NodeMode
     */
    default ZookeeperWriter<K, V> create(K k, V v, NodeMode mode, ZookeeperSerializer serializer)
     ...
     * @see NodeMode
     */
    ZookeeperWriter<K, V> create(K k, V v, NodeMode mode, boolean recurse, ZookeeperSerializer serializer)
            throws OctopusZookeeperException;
     ...
     * @throws OctopusZookeeperException failed
     */
    default ZookeeperWriter<K, V> update(K k, V v) throws OctopusZookeeperException {
     ...
     * @throws OctopusZookeeperException failed
     */
    default ZookeeperWriter<K, V> update(K k, V v, ZookeeperSerializer serializer) throws OctopusZookeeperException {
     ...
     * @throws OctopusZookeeperException failed
     */
    default ZookeeperWriter<K, V> update(K k, V v, Integer version) throws OctopusZookeeperException {
     ...
     * @throws OctopusZookeeperException failed
     */
    ZookeeperWriter<K, V> update(K k, V v, Integer version, ZookeeperSerializer serializer)
            throws OctopusZookeeperException;
